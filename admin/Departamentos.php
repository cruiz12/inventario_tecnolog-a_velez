...
<div class="wrapper">
  ...
  <?php 
    ...
    ?>
    <!-- CONTENEDOR CUERPO "DEPARTAMENTOS" -->
<div class="content-wrapper">
  <div class="text-center">
    ...
    if($row['rol'] == 'SuperAdministrador' || $row['rol'] == 'Administrador'){
      // SI TIENE ROL ADMIN O SUPERADMIN MUESTRE... ?>
  <button class="btn-add-dueño" id="ModalEnsayo" data-toggle="modal" data-target="#staticBackdrop">Añadir Departamento</button>
<?php
}else{
...
?>
  ...
  <!-- MESSAGES -->
    ...
    ?>
 <!-- MODAL FORMULARIO AÑADIR DEPARTAMENTO -->
   <?php 
   if($row['rol'] == 'SuperAdministrador' || $row['rol'] == 'Administrador'){
    // SI TIENE ROL ADMIN O SUPERADMIN MUESTRE... ?>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Añadir Departamento:</h3>           
        </div>
           
           <form action="Añadir_Departamento.php" method="POST">
            <div class="form-group">
              <label for="nombre_ciudad">Nombre:</label>
              <input type="text" name="nombre_departamento" class="form-control" placeholder="Nombre Departamento" required>
            </div>
            <div class="form-group">
            ...
            <div class="modal-footer">
              <input type="submit" name="agregar_departamento" class="btn btn-success" value="Agregar">
...
<!-- DATATABLE PROVEEDOR -->
  <div class="datatable-responsive datatable-box">
   ...
   <?php 
    if($row['rol'] == 'SuperAdministrador' || $row['rol'] == 'Administrador'){
      // SI TIENE ROL ADMIN O SUPERADMIN MUESTRE... ?>
     <a href="Edit_Departamento.php?idDepartamento=<?php echo $mostrar['idDepartamento']?>" title="Editar Departamento" class="btn btn-secondary">
                <i class="icofont-ui-edit"></i>
              </a>
              <a href="#" onclick="preguntar(<?php echo $mostrar['idDepartamento']?>)" title="Eliminar Departamento" class="btn btn-danger">
...
<script type="text/javascript">
      function preguntar(id)
      {
        ...
        {
          window.location.href = "Delete_Departamento.php?idDepartamento="+id;
        }
      }
</script>
