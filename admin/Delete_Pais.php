...
if(isset($_POST['delete'])){
  ...
  $query3="DELETE FROM paises WHERE idPais = $idPais";
  $ResultadoDeletePais = $con->query($query3);

  if($ResultadoDeletePais){
  echo "<script>alert('Los datos del país se han eliminado correctamente');window.location='Ciudades.php'</script>";
  }else{
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #55565a; color: #fff">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Eliminando el país: "<?php echo $row2['nombre_pais']; ?>"</h3>   
