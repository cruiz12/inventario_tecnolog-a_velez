...
<div class="wrapper">
 ...
 <?php 
  ...
  ?>
<!-- CONTENEDOR CUERPO "EDITAR MARCA" -->
...
/* AQUI REALIZAMOS EL UPDATE DEL REGISTRO QUE SE SELECCIONÓ */
  ...
  $ResultadoEditMarca = $con->query($query);

  if($ResultadoEditMarca){
  echo "<script>alert('Los datos de la marca se han actualizado correctamente');window.location='Marcas.php'</script>";
  }else{
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #55565a; color: #fff ">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Editando a: "<?php echo $row2['nombre_marca']; ?>"</h3>   
        <hr style="background-color: #fff; ">
        <form action="" method="POST">
            <div class="form-group">
              <label for="nombre_marca">Nombre:</label>
              <input type="text" name="nombre_marca" class="form-control" value="<?php echo $row2['nombre_marca']; ?>" placeholder="Actualizar Nombre">
            </div>
            <hr style="background-color: #fff; ">
            <h4 style=" text-align: center;">¡Revisa la información antes de realizar algún cambio!</h4>
            <div class="botones">
              <button name="updatemarca" class="btn btn-success">Actualizar</button>
