...
<div class="content-wrapper">
  <div class="text-center">
    ...
    if($row['rol'] == 'SuperAdministrador' || $row['rol'] == 'Administrador'){
      // SI TIENE ROL ADMIN O SUPERADMIN MUESTRE... ?>
  <button class="btn-add-dueño" id="ModalEnsayo" data-toggle="modal" data-target="#staticBackdrop">Añadir Marca</button>
<?php
}else{
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Añadir Marca:</h3>           
        </div>
           
           <form action="Añadir_Marca.php" method="POST">
            <div class="form-group">
              <label for="nombre_marca">Nombre:</label>
              <input type="text" name="nombre_marca" class="form-control" placeholder="Nombre Marca" required>
            </div>
         
            <div class="modal-footer">
              <input type="submit" name="agregar_marca" class="btn btn-success" value="Agregar">
...
<!-- DATATABLE MARCAS -->
  <div class="datatable-responsive datatable-box">
   ...
   <?php 
    if($row['rol'] == 'SuperAdministrador' || $row['rol'] == 'Administrador'){
      // SI TIENE ROL ADMIN O SUPERADMIN MUESTRE... ?>
     <a href="Edit_Marca.php?id_marca=<?php echo $mostrar['id_marca']?>" title="Editar Marca" class="btn btn-secondary">
                <i class="icofont-ui-edit"></i>
              </a>
              <a href="#" onclick="preguntar(<?php echo $mostrar['id_marca']?>)" title="Eliminar Marca" class="btn btn-danger">
...
<script type="text/javascript">
      function preguntar(id)
      {
        ...
        {
          window.location.href = "Delete_Marca.php?id_marca="+id;
        }
      }
</script>
