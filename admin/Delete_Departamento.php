...
if(isset($_POST['delete'])){
  ...
  $query3="DELETE FROM departamento WHERE idDepartamento = $idDepartamento";
  $ResultadoDeleteDepartamento = $con->query($query3);

  if($ResultadoDeleteDepartamento){
  echo "<script>alert('Los datos del departamento se han eliminado correctamente');window.location='Departamentos.php'</script>";
  }else{
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #55565a; color: #fff">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Eliminando el Departamento: "<?php echo $row2['nombre_departamento']; ?>"</h3>   
