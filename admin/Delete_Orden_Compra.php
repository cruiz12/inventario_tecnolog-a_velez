...
<div class="wrapper">
  ...
  ?>
  <!-- CONTENEDOR CUERPO "BORRAR ORDEN DE COMPRA" -->
...
if(isset($_POST['delete'])){
  ...
  $query3="DELETE FROM orden_compra WHERE id_orden = $id_orden";
  $ResultadoDeleteOrden = $con->query($query3);

  if($ResultadoDeleteOrden){
  echo "<script>alert('Los datos de la orden de compra se han eliminado correctamente');window.location='Proveedor.php'</script>";
  }else{
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #55565a; color: #fff">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Eliminando la orden número: "<?php echo $row2['id_orden']; ?>"</h3>   
